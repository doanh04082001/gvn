...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'product.toppings.*.id' => [
            'required' => 'Topping không tồn tại.',
            'exists' => 'Topping đã thay đổi.',
        ],
        'user_stores.*' => [
            'exists' => 'Chi nhánh đã thay đổi.',
        ],
        'user_role' => [
            'exists' => 'Chức vụ đã thay đổi.',
        ],
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Messages of Rules
    |--------------------------------------------------------------------------
    */
    'accept_to_change_permission' => 'Gán quyền không hợp lệ.',
    'required_without_custom' => 'Trường :attribute không được bỏ trống',
    'required_if_combo_custom' => 'Trường :attribute không được bỏ trống',
    'required_if_combo_array_custom' => ':attribute không được bỏ trống',
    'allow_order_status' => 'Không thể cập nhật từ trạng thái <b>:from_status</b> sang <b>:to_status</b>',
    'password_incorrect' => 'Mật khẩu cũ của bạn không đúng!',
];
