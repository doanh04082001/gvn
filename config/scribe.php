...
$baseUrl = env('APP_USE_SUB_DOMAIN') && empty(env('APP_ONLY')) ? apiUrl() : null;
$domains = ['*'];
$prefixes = env('APP_USE_SUB_DOMAIN') ? ['v1/*'] : ['api/v1/*', 'sale-api/v1/*'];
$docsUrl = '/docs';
$middleware = ['api', 'sale-api'];

if (env('APP_ONLY') == 'api') {
    $baseUrl = env('APP_USE_SUB_DOMAIN') ? apiUrl() : null;
    $domains = env('APP_USE_SUB_DOMAIN') ? ['api.*'] : ['*'];
    $prefixes = env('APP_USE_SUB_DOMAIN') ? ['v1/*'] : ['api/v1/*'];
    $docsUrl = env('APP_USE_SUB_DOMAIN') ? '/docs' : 'api/docs';
}

if (env('APP_ONLY') == 'sale-api') {
    $baseUrl = env('APP_USE_SUB_DOMAIN') ? saleApiUrl() : null;
    $domains = env('APP_USE_SUB_DOMAIN') ? ['sale-api.*'] : ['*'];
    $prefixes = env('APP_USE_SUB_DOMAIN') ? ['v1/*'] : ['sale-api/v1/*'];
    $docsUrl = env('APP_USE_SUB_DOMAIN') ? '/docs' : 'sale-api/docs';
    $middleware = ['sale-api'];
}
...
return [
     ...
     */
    'title' => env('APP_NAME', 'Laravel') . ' API documents',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => env('APP_NAME', 'Laravel') . ' API documents',
